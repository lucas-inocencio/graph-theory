...
public:
    ...
    LinkedListNode() : id_{0}, capacity_{0}, allocation_flow_{0}, is_reverse_{false}, next_{nullptr} {}
    LinkedListNode(int id, int capacity) : id_{id}, capacity_{capacity}, allocation_flow_{0}, is_reverse_{false}, next_{nullptr} {}
    LinkedListNode(int id, int capacity, bool is_reverse) : id_{id}, capacity_{capacity}, allocation_flow_{0}, is_reverse_{is_reverse}, next_{nullptr} {}
